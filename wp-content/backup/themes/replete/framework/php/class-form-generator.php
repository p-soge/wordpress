...
if( ! class_exists( 'avia_form' ) )
{
	class avia_form
	{
		...
		function send()
		{
			...
			$proceed = apply_filters('avia_form_send', true, $new_post, $this->form_params);
			...
			if($usermail && !empty($this->form_params['autoresponder']))
			{
				...
				$message = nl2br($this->form_params['autoresponder'])."<br/><br/><br/><strong>Your Message:</strong><br/><br/>".$message;
