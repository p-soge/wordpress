...
if ( ! class_exists( 'avia_update_notifier' ) )
{
    class avia_update_notifier
    {
            ...
            if ( !get_user_meta($this->userid, 'avia_ignore_update_message') && empty($avia_ignore_update_message_temporarily) && current_user_can('manage_options') )
            {
                ...
                echo '<div class="updated">';
                    echo '<p>';
                        ...
                        echo '<a href="?avia_ignore_update_message_temporarily=1" title="' . __('Remind Me Later', 'avia_framework') . '">'. __('Remind Me Later', 'avia_framework') . '</a>';
                        echo $saparator;
                        echo '<a href="?avia_ignore_update_message=1" title="' . __('Ignore the update notice this time', 'avia_framework') . '">'. __('Ignore This Update Notice', 'avia_framework') . '</a>';
        ...
        public function avia_ignore_update_message()
        {
            ...
            */
            if ( isset($_GET['avia_ignore_update_message']) && '1' == $_GET['avia_ignore_update_message'] )
            {
                add_user_meta($this->userid, 'avia_ignore_update_message', 'true', true);
            }

            /* Temporarily ignore the update message */
            if ( isset($_GET['avia_ignore_update_message_temporarily']) && '1' == $_GET['avia_ignore_update_message_temporarily'] )
            {
